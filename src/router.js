...
const routes = [
  {
    path: "/",
    redirect: () => (tokenService.get() ? "/calculation" : "/login")
  },
  ...
  { path: "/orders/create", component: Order, meta: { requiresAuth: true } },
  { path: "/orders/:id", component: Order, meta: { requiresAuth: true } },
